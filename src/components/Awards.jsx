      ...
      <div className="container">
        ...
        <div className="awards-content">
          <div className="awards-images-vertical">
            <img
              src={awardImage}
              alt="National Bravery Awards"
              className="award-img-large"
            />
            <img
              src={awardImage1998}
              alt="Award 1998"
            ...
            <ul className="honors-list">
              <li>
                ...
                <span className="award-desc">
                  For community leadership in ending child labour
                </span>
              </li>
              <li>
                <span className="award-title">Padma Shri</span>
                <span className="award-desc">
                  Government of India civilian award
                </span>
              </li>
              <li>
                <span className="award-title">
                  Albert Shanker International Award (1999)
                </span>
                <span className="award-desc">
                  Recognition of excellence in child rights advocacy
                </span>
              </li>
              <li>
              ...
              <li>
                <span className="award-title">
                  Hyderabad Women of the Decade Achievers Award
                </span>
                <span className="award-desc">
                  For exceptional contributions to society
                </span>
              </li>
              <li>
                <span className="award-title">
